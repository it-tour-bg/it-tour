module SpecSupport
  # Note(rstankov) - copied from unreleased CarrierWave 0.11.0. When it is released remove and use theirs.

  if CarrierWave::VERSION != '0.10.0'
    raise 'Replace SpecSupport::CarrierWaveTest with CarrierWave::Test::Matchers'
  end
...
module SpecSupport
  module UploaderHelper
    include ::SpecSupport::CarrierWaveTest::Matchers
